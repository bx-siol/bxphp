                ...
                <template #default="{ list }">
                    <van-card :desc="t('描述信息')" :title="t('商品标题')" :thumb="imgFlag(item.icon)"
                        ...
                        <template #num>
                            ...
                            <template v-else>
                                <span
                                    style="font-size: 1rem;height: 1.8rem;line-height: 1.8rem;color: #bd312d;display: inline-block;">{{
                                        t('结束') }}</span>
                            </template>
                        </template>
                        <template #desc>
                        ...
                        <template #price>
                            <span
                                style="color: #ffffff;font-size: 0.9rem;line-height: 1.8rem;height: 1.8rem;display: inline-block;">{{

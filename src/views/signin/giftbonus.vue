                    ...
                    <div class="lisks">
                        <div style="height:6rem;">
                            ...
                            <div style="width: 70%; float: right; height: 4rem;">
                                <div style="font-size: 0.85rem; font-weight: bold;" v-if="item.id == 33">Invite 2 people
                                    join 【{{ item.name }}】</div>
                                <div style="font-size: 0.85rem; font-weight: bold;" v-else>Invite 1 people join
                                    【{{ item.name }}】</div>
                                <div style="margin-top:0.5rem;">
                                    <div style="width: 55%; float: left; color: #7b7b7b;font-size:0.8rem;">Daily Earnings
                                    </div>
                                    <div
                                        style="width: 45%; float: right; color: #008260; text-align: right; font-size: 0.8rem;">
                                        {{ cutOutNum((item.rate / 100) * item.price) }} RS</div>
                                </div>
                                <div style="margin-top:0.5rem;">
                                    <div style="width: 55%; float: left; color: #7b7b7b; font-size: 0.8rem;">Total Revenue
                                    </div>
                                    <div
                                        style="width: 45%; float: right; color: #008260; text-align: right; font-size: 0.8rem;">
                                        {{ cutOutNum((item.rate / 100) * item.price * item.days) }} RS</div>
                                </div>
                                <div style="margin-top:0.5rem;">
                                    <div style="width: 55%; float: left; color: #7b7b7b; font-size: 0.8rem;">Revenue Cycle
                                    </div>
                                    <div
                                        style="width: 45%; float: right; color: #008260; text-align: right; font-size: 0.8rem;">
                                        {{ item.days }} Day</div>

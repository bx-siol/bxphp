<template>
            ...
            <el-tree
                ...
                <template #default="{ node, data }">
                    ...
                    <div class="treeItemTool">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <el-button size="small" type="danger" icon="el-icon-delete" circle @click.stop="del(node,data)"></el-button>
                        <el-button size="small" type="success" icon="el-icon-edit" circle @click.stop="edit(node,data)"></el-button>
                        <el-button size="small" type="primary" icon="el-icon-plus" circle @click.stop="add(data)"></el-button>
                    </div>
                </template>
            </el-tree>
    ...
    <!--弹出层-->
    <el-dialog :title="configForm.title" v-model="configForm.visible" :close-on-click-modal="false" :width="configForm.width" :top="configForm.top">
        <el-form :label-width="configForm.labelWidth">
            ...
            <el-form-item label="排序值" style="margin-bottom: 0;">
            ...
            <el-form-item label="前台状态" style="margin-bottom: 0;">
...
<script lang="ts" setup>
    ...
    import {getSrcUrl, _alert, getZero} from "../../global/common"
    ...
    const power=reactive({
        update:checkPower('News_category_update'),
        delete:checkPower('News_category_delete')
    })
...
<style>
    ...
    .treeItemLabel{display: inline-block;width: 200px;}
    .treeItemTool{width: 400px;display:inline-block;text-align: right;line-height: 28px;border: 0px solid;}
</style>
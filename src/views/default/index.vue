  ...
  <div class="index">
    ...
    <div class="index_wrap">
      <div class="index_top">
        <div class="headbox">
          ...
          <van-image :src="illustration" style=" width: 11rem;left: 26%;"></van-image>
        ...
        <div class="backg">
            <div class="myswiper" style=" margin-bottom: 1rem">
                <MySwiper :kv="tdata.kv" height="12.5rem"></MySwiper>
            </div>
            <div class="giftbonus" v-if="false" @click="onLink({ name: 'giftbonus' })"></div>
            <div class="luckyDraw" @click="onLink({ name: 'Gift_lottery' })"></div>

            <div class="index_cer">
                <div class="menubox">
                    <div style=" display: flex; flex-wrap: wrap; justify-content: center; justify-content: space-between; width: 90%; margin: auto;">
    ...
    <div class="malls u-flex u-bet">
      ...
      popular products
                    ...
                    <div style="color: white; background: #eb1700; text-align: center; padding: 0.4rem;">Project</div>
                    <div class="products" style=" width: 90%; margin: auto;">
                        <HomeProjects />
                    </div>
                </div>
            </div>
...
import nestie from '../../assets/img/home/nestie.jpg'
    import illustration from '../../assets/img/login/ornament2.png';
  ...
  .dialog_confirm_btn {
    ...
    .index_wrap {
        ...
        .luckyDraw {
            ...
            height: 6rem;
            margin: auto;
            background-image: url('../../assets/img/lottery/index.png');
            /* 设置图片路径 */
            background-size: 100% 100%;
            /* 背景图片覆盖整个元素 */
            background-repeat: no-repeat;

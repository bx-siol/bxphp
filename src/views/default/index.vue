<template>
  <div class="index">
    ...
    <van-dialog v-model:show="tipShow" style="border-radius:0;background-color:transparent;" :showConfirmButton="false"
      class-name="home_tip_show" class="home_tip_shows">

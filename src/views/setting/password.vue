<template>
    <div class="conBox">
        ...
        <van-form @submit="onSubmit">
            <van-cell-group>
                <van-field v-model="dataForm.account" v-if="false" readonly>
                    <template #left-icon>
                ...
                <van-field v-model="dataForm.phone_flag" readonly>
                    <template #left-icon>
                        <van-image :src="ico_1" width="1.8rem" fit="cover"
                                   style="vertical-align: middle; margin-left: -0.25rem; position: relative; top: -3px; width: 4vw;" />
                    </template>
                    <template #right-icon v-if="false">
                        {{ t('发送手机号') }}
                    </template>
                </van-field>
                ...
                <van-field v-model="dataForm.scode" :placeholder="t('短信验证码')" class="dilate">
                    <template #left-icon>
                        <van-image :src="ico_3" width="1.8rem" fit="cover"
                                   style="vertical-align: middle; margin-left: -0.25rem; position: relative; top: 0.4rem; width: 4vw;" />
                    </template>
                    <template #button>
            ...
            <div style="padding:0 2rem 1rem;">
                <van-button class="myBtn" style=" background: rgb(235 23 0); border-radius: 25px;" round block type="primary" native-type="submit">{{ t('提交') }}</van-button>
            </div>
        </van-form>
    </div>
</template>
...
<script lang="ts" setup>
    import ico_1 from '/src/assets/ico/u5.png'
    import ico_2 from '/src/assets/ico/u4.png'
    import ico_3 from '/src/assets/ico/u7.png'

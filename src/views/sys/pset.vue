            ...
            <el-tab-pane label="通用设置" name="first">
                <el-form style="width: 50%;" :label-width="configForm.labelWidth">
                    ...
                    <el-form-item label="联系地址">
                        <el-input type="textarea" v-model="contact.address" autocomplete="off" rows="2"></el-input>
                    </el-form-item>
                    <el-form-item label="工作时间">
                        <el-input v-model="copyright.worktime" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="版权信息">
                        <el-input v-model="copyright.slogan" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="备案信息">
                        <el-input v-model="copyright.icp" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="微信二维码">
                        <Upload v-model:file-list="wxCoverList"></Upload>
                    </el-form-item>
                    <el-form-item label="微信号">
                        <el-input v-model="service.wx.account" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="QQ二维码">
                        <Upload v-model:file-list="qqCoverList"></Upload>
                    </el-form-item>
                    <el-form-item label="QQ号">
                        <el-input v-model="service.qq.account" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="Telegram">
                        <Upload v-model:file-list="telgCoverList"></Upload>
                    </el-form-item>
                    <el-form-item label="Tele账号" style="margin-bottom: 0;">
                        <el-input v-model="service.telegram.account" autocomplete="off"></el-input>
                    </el-form-item>
            ...
            <el-tab-pane label="项目设置" name="second">
                <el-form :label-width="configForm.labelWidth2" label-suffix="：">
                    ...
                    <el-form-item label="APP下载地址">
                        <el-input v-model="app.download" autocomplete="off"></el-input>
                    </el-form-item>
                    <!--                    <el-form-item label="美元兑Rs汇率">
                        <el-input v-model="project.usd2rs" autocomplete="off" style="width: 400px;"></el-input>
                    </el-form-item>-->
                    <el-form-item label="返佣设置">
                        <el-input v-model="project.commission" autocomplete="off" style="width: 400px;"></el-input>
            ...
            <el-tab-pane label="余额相关" name="third">
                <el-form style="width: 50%;" :label-width="configForm.labelWidth2">
                    <el-form-item label="单笔最小充值">
                        <el-input v-model="balance.pay.min" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="单笔最大充值">
                        <el-input v-model="balance.pay.max" autocomplete="off"></el-input>
                    </el-form-item>

                    <el-form-item label="卡单笔最小充值">
                        <el-input v-model="balance.pay.kmin" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="卡单笔最大充值">
                        <el-input v-model="balance.pay.kmax" autocomplete="off"></el-input>
                    </el-form-item>

                    <el-form-item label="单笔最小提现">
                        <el-input v-model="balance.cash.min" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="单笔最大提现">
                        <el-input v-model="balance.cash.max" autocomplete="off"></el-input>
                    </el-form-item>

                    <el-form-item label="提现手续费">
                        <el-input style="width: 100px;" placeholder="" v-model="balance.cash.fee.percent">
                        </el-input>
                        <b style="padding-right: 20px;">%</b>
                        <b style="padding-right: 20px;font-size: 1.5rem;">+</b>
                        <el-input style="width: 100px;" placeholder="" v-model="balance.cash.fee.money">
                        </el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="可提现时间">
                        <el-time-picker is-range style="width: 271px;" :editable="false" v-model="cashTimeFlag"
            ...
            <el-tab-pane label="抽奖设置" name="fourth">
                <el-form :label-width="configForm.labelWidth2" label-suffix="：">
                    <el-form-item label="库存余额">
                        <el-input v-model="lottery.stock_money" autocomplete="off" style="width: 400px;"></el-input>
                    </el-form-item>
                    <el-form-item label="中奖金额">
                        <el-row>
                            <el-col :span="2">
                                <el-input v-model="lottery.from_money" autocomplete="off"></el-input>
                            </el-col>
                            <el-col :span="1">
                                <span style="padding-left: 40%;">到</span>
                            </el-col>
                            <el-col :span="2">
                                <el-input v-model="lottery.to_money" autocomplete="off"></el-input>
                            </el-col>
                        </el-row>
                    </el-form-item>
                    <el-form-item label="单个用户">
                        <el-input v-model="lottery.day_limit" autocomplete="off" style="width: 400px;"
                            placeholder="0或空则不限"></el-input>
                        <span> 次/天 0或空则不限</span>
                    </el-form-item>
                    <el-form-item label="单个用户">
                        <el-input v-model="lottery.week_limit" autocomplete="off" style="width: 400px;"
                            placeholder="0或空则不限"></el-input>
                    ...
                    <el-form-item label="抽奖次数额度">
                        <el-input v-model="lottery.lottery_min" autocomplete="off" style="width: 400px;" placeholder="">
                        </el-input>

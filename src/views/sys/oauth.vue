<template>
    ...
    <div class="conbox">
        <div>
                ...
                <el-tab-pane label="授权分组" name="first">
                    <el-form :label-width="configForm.labelWidth">
                        <el-form-item label="分组">
                            <el-select size="small" v-model="searchForm.s_gid" placeholder="请选择" style="width: 200px;"
                                @change="searchGroup">
                ...
                <el-tab-pane label="授权个人" name="second">
                    <el-form :label-width="configForm.labelWidth">
                        <el-form-item label="账号">
                            <el-input size="small" v-model="searchForm.s_account" autocomplete="off"
            ...
            <el-tree :data="dataForm.list" show-checkbox default-expand-all node-key="id" ref="tree" highlight-current
                check-on-click-node check-strictly :expand-on-click-node="false"
                :default-checked-keys="dataForm.checked" :props="dataForm.defaultProps">
            </el-tree>

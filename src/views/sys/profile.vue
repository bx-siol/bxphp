            ...
            <el-col :span="10">
                <el-form :style="{width:configForm.width}" :label-width="configForm.labelWidth">
                    ...
                    <el-form-item label="手机号" v-if="userinfo.phone">
                        <el-input v-model="userinfo.phone" autocomplete="off" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="分组">
                        <el-input v-model="userinfo.gname" autocomplete="off" disabled></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="当前二级密码">
                        <el-input v-model="userinfo.password2_ck_flag" type="password" autocomplete="off" placeholder=""></el-input>
                    </el-form-item>

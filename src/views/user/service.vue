<template>
    <div class="service_page">
        ...
        <div style="background-color: #fff;color: #002544;border-radius: 16px;padding: 1rem;">
            <div class="content2">
                <div v-for="item,index in service_arr" style=" border: 1px solid #80808045; border-radius: 6px;">
                    <img :src="item.type == 1 ? Telegram : WhatsApp">
                    <div>{{ item.name }}</div>
                    <van-button class="infoBtn" :style="item.type==1?'':'background:#25d366'"
            ...
            <div class="content3">
                <div>Welcome to J&J, the customer service manager is online from 10 am to 10 pm every day.</div>

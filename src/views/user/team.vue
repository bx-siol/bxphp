<template>
    <div class="paylogBox" style="        height: 100%;
        ...
        <div class="will">
            <div class="card">
                <div>
                    <vue-qrcode style="width: 28vw; margin: auto; " :value="montage.urls"></vue-qrcode>
                    <div style="border-right: 1px solid #80808040;" class="topItem">
                        {{t('团队规模')}}:<span style="        color: #db1000;
        font-weight: bold;
">{{ teamcount }}</span> (people)
                    </div>
                    <div class="topItem">
                        {{t('充值')}}:<span style="        color: #db1000;
        font-weight: bold;
">{{ recharge }}</span>（Rs）
                    </div>
                </div>
                <div style=" font-size: .7rem; border: 1px solid #db100096; border-radius: 6px; padding: 0.4vh 0; margin-top: 1vh;">
        ...
        color: white;
        height: 4vh;
        line-height: 4vh;">{{t('邀请链接')}}</div>
                    <div style="        display: inline-block;
        width: 50vw;
        overflow: scroll;
        height: 2vh;
        line-height: 2.5vh;">{{ montage.urls }}</div>
                    <div @click="copyToClipboard(montage.urls)" style="display: inline-block;
        width: 12vw;
        border-radius: 6px;
        background: #cc1700;
        color: white;

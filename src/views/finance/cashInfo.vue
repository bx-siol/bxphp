        ...
        <van-form @submit="onSubmit">
            <van-cell-group >
                ...
                <van-field :label-width="configForm.labelWidth" :label-align="configForm.labelAlign"
                           label="接收地址">
                    <template #input>
                        <div style="word-break: break-all;line-height: 1.5rem;">{{info.receive_address}} <van-button :data-clipboard-text="info.receive_address" class="copyBtn" type="warning" size="mini" style="position: relative;top:-5px;display: none;">复制</van-button></div>
                    </template>
                </van-field>
                <van-field :label-width="configForm.labelWidth" :label-align="configForm.labelAlign"
                           label="时间">
...
<style scoped>
    .rowInfo{word-break:break-all;width: 100%;}
    .rowInfo button{vertical-align: middle;}
</style>

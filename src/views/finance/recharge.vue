<template>
    <div class="recharge">
        <MyNav leftText=''> 
            <template #right>
                <span style="color:white" @click="onLink({ name: 'Finance_rechargelog' })">Record</span>
            </template>
        </MyNav>
        <div class="recharge_wrap">
            ...
            <van-button class="submitBtn" @click="onSubmit"
                        style="background-color: rgb(235, 23, 0); color: #fff; height: 2.25rem; width: 21rem; border-radius: 20px; ">
                {{ t('充值') }}
            </van-button>
            <div style="margin-top: 2rem;" class="title" v-if="false">
                <b>Payment channel</b>
            </div>
            <div class="payway">
                <div style="width: 100%;" class="notice">
                    <van-radio-group style="width: 100%;" v-model="checked">
                        <van-cell-group style="font-size: 1.2rem;">
                            <van-cell v-for="item,index in ptypeArr" @click="checked = item.id">
                                <template #title>
                                    <div :style="{'display': 'inline-block', 'align-items': 'center', 'border-right':(index+1)%3==0?'':' 1px solid #80808038','width': '4rem'} " class="van-cell__title">
                                    ...
                                    <img class="" :src="dpimg"> </i>-->
                                        <span class="Selected"
                                              :style="{ 'color': (checked == item.id ? 'rgb(235, 23, 0)' : '#827977') }">
                                            {{
                                                item.name
                                            }}
                                        </span>
            ...
            <div class="payway">
                <div class="title">
                    <van-image style=" width: 6vw;" :src="light" v-if="false"></van-image>
            ...
            <div class="rechargeNotice">
                ...
                <div class="noticeList">
                    ...
                    <div class="noticeListItem">
                        <span>5. if the recharge has not arrived, please log in to your account again orcontact your customer service manager</span>
                    </div>
                </div>
            </div>

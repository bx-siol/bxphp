<template>
    <div class="recharge">
        <MyNav leftText=''>
            <template #right>
                <span style="color:white" @click="onLink({ name: 'Finance_withdrawlog' })">Record</span>
            </template>
        </MyNav>
        ...
        <div class="notice">
            <span class="noticeText">PaymentPassword:</span>
                ...
                <div class="payinfo" style="margin-top: 1rem;text-align:center">
                    <p v-if="false" class="tit">{{ t('银行账户') }}</p>
                    <div>
                        <div class="wdInfoItem">
                            <div>{{ dataForm.money * tar / 100 }}RS</div>
                            <div>{{ t('税收') }}</div>
                        </div>
                        <div class="wdInfoItem">
                            <div>{{ tar }}%</div>
            ...
            <div class="withdrawalNotes">
                <div class="notice">
                    <!-- <img :src="hexagon"> -->
                    <van-image v-if="false" style=" width: 6vw;" :src="light"></van-image>
                ...
                <div class="noticeList">
                    ...
                    <div class="noticeListItem">
                        <span>5.If the withdrawal fails, please reapply or check whether your bankaccount information is correct.</span>
                    </div>
                    <div class="noticeListItem">
                        <span>6.IFSC should be 11 characters, and the 5th character should be "0"not "O". lf you fill in incorrect bank information, your withdrawal will fail.</span>
                    </div>
                </div>
            </div>

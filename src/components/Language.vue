<template>
    <div style="float: right; position: absolute; left: 4vw; color: white; margin-top: -4vh; ">{{ dataForm.language_name }}</div>
    <div v-if="props.showAct" class="switchLan"
        ...
        <span :style="props.style" @click="onAction" v-else>
            ...
            <van-icon :name="$store.state.showLanguage ? 'arrow-up' : 'arrow-down'" style="vertical-align: middle;color: red" />
        </span>
    </div>

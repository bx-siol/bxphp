        ...
        <template #default="{ list }">
          <div class="basicProjectsList">
            <div v-for="(item, index) in list" :key="index" class="bottom">
              <div
                :style="{ 'width': '100%', 'box-shadow': 'none', 'background': `url(${item.money != 0 ? yhj1 : yhj2})`, 'background-size': '100% 100%','height':'auto','padding-left':'3vw' }"
                class="basicItem">
                  <div style=" color: white; line-height: 1.4vh;">
                      ...
                      <div style=" font-size: 1.8rem; font-weight: bold; vertical-align: super; color: white; height: 3vh; line-height: 4vh;" v-if="item.money != 0"><span>{{item.money }} RS</span><span @click="usefun(item)" :style="{'color': 'rgb(162 117 76)'}" class="exchangeLB">Exchange</span></div>
                      <div style=" font-size: 1.8rem; font-weight: bold; vertical-align: super; color: white; height: 3vh; line-height: 4vh;" v-if="item.money == 0"><span>{{ 100 - item.discount }}%</span><span @click="usefun(item)":style="{'color': 'rgb(33, 137, 255)'}" class="exchangeLB">Exchange</span></div>

                ...
                <div class="basicItemRight">
                  <div class="name">
                    <div style=" font-size: .8rem;">
                      <div style="display: inline-block; width: 70%;">{{ item.name }} </div>
                      <div style="display: inline-block; color: #eb1700;text-align:right;"> {{item.price}}RS</div>
                    </div>
                  ...
                  <div class="detail">
                    <div class="detailLeft">
                      <div class="unitprice">
                          <span>Earnings Days: </span>
                          <span style="color:gray">{{ item.days }} days</span>
                      </div>
                      <div class="dailyearnings">
                        <span>{{ t('每日收入') }}: </span>
                        <span style="color: gray">₹{{ cutOutNum(item.price * item.rate / 100) }}</span>
                      </div>
                ...
                .basicItem {
                    ...
                    .basicItemRight {
                        ...
                        .name {
                            ...
                            span {
                                background: #eb1700 url(../assets/djs.png) 3px center no-repeat;

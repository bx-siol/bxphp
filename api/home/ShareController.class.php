...
class ShareController extends BaseController
{
	...
	public function _getTakDat()
	{
		...
		$return_data = [
			...
			'threedayRecharge_5' => $threedayRecharge_5,
			'threedayRecharge_10' => $threedayRecharge_10,
			'regstart_5' => $regstart_5,
			'regend_5' => $regend_5,
	...
	public function _ClaimRS()
	{
		...
		try{
			...
			$db_item = [
				...
				'create_day' => date('Ymd', time()),
				'create_id' => intval($pageuser['id']),
				'remark' => 'Invite 3 people to register and recharge today to get 50RS.',
				'ori_balance' =>  $wallet['balance'],
				'new_balance' => $wallet_data['balance']
			];
			$res = Db::table('wallet_log')->insertGetId($db_item);
	...
	public function _FivePersonReward()
	{
		...
		try{
			...
			$db_item = [
				...
				'create_day' => date('Ymd', time()),
				'create_id' => intval($pageuser['id']),
				'remark' => 'Invite 5 people to register and recharge today to get 100RS.',
				'ori_balance' =>  $wallet['balance'],
				'new_balance' => $wallet_data['balance']
			];
			$res = Db::table('wallet_log')->insertGetId($db_item);
	...
	public function _TenPersonReward()
	{
		...
		try{
			...
			$db_item = [
				...
				'create_day' => date('Ymd', time()),
				'create_id' => intval($pageuser['id']),
				'remark' => 'Invite 10 people to register and recharge today to get 200RS.',
				'ori_balance' =>  $wallet['balance'],
				'new_balance' => $wallet_data['balance']
			];
			$res = Db::table('wallet_log')->insertGetId($db_item);
	...
	public function TimeInterval($top)
	{
		...
		return ['$regstart' =>$regstart,'$regend' =>$regend ];
	}
}

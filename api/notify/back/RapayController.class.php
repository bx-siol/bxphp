...
class RapayController extends BaseController
{
	...
	public function _pay()
	{
		...
		$logpathd = LOGS_PATH . "rapay/notify/pay{$time}.txt";
	...
	public function _cash()
	{
		...
		$time = date("Y-m-d", time());
		$logpathd = LOGS_PATH . "rapay/notify/cash{$time}.txt";
		...
		$pdata = [
			...
			'pay_msg' => $params['payTime'] . '-' . $params['charge'],

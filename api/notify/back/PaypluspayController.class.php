...
class PaypluspayController extends BaseController
{
	...
	public function _cpay()
	{
		...
		$url = 'http://upi.payplus.live/api/pay';
	...
	public function _ccash()
	{
		...
		$params['notifyUrl'] = urldecode($params['notifyUrl']);
		$url = 'http://upi.payplus.live/api/pay/repay';
		$result =  $this->CurlPost($url, $params, 30);
		$json_str = json_encode($result, 256);
		echo $json_str;
	}
	...
	public function _pay()
	{
		...
		$logpathd = LOGS_PATH . 'paypluspay/notify/' . "pay" . $time . ".txt";
	...
	public function _cash()
	{
		...
		$logpathd = LOGS_PATH . 'paypluspay/notify/' . "cash" . $time . ".txt";

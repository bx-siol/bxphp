...
class UepayController extends BaseController
{
	...
	public function _pay()
	{
		...
		$logpathd = LOGS_PATH . "uepay/notify/pay{$time}.txt";
		...
		$pdata = [
			'code' => $params['trade_state'] == '1' ? 1 : -1,
			'osn' => $params['out_trade_no'],
			'amount' => $params['actual_amount'] / 100,
			'successStr' => 'success'
		];
		$this->payAct($pdata);
	}
	...
	public function _cash()
	{
		...
		$time = date("Y-m-d H:i:s", time());
		$logpathd = LOGS_PATH . "uepay/notify/cash{$time}.txt";

...
function balance()
{
    ...
    writeLog("11111" , GetPayName() . '/balance');
    writeLog("data" .json_encode($data, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) , GetPayName() . '/balance');
    writeLog("22222" , GetPayName() . '/balance');

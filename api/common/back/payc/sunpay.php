...
$_ENV['PAY_CONFIG']['sunpay'] = [
	'mch_id' => '991109606',
	'mch_key' => 'ac7b75e32f524c1d8fac5dfd341600bd',
...
function payOrder($fin_paylog, $sub_type = '')
{
	...
	$logpathd = LOGS_PATH . "sunpay/pay/{$time}.txt";
	...
	*/
	$pdata = [
		...
		'pay_type' => $sub_type == 0 ? 101 : $sub_type, //通道编码，商户后台有配置
...
function payCurlPost($url, $data = [], $timeout = 30)
{
	...
	$time = date("Y-m-d", time());
	$logpath = LOGS_PATH . "sunpay/Post{$time}.txt";

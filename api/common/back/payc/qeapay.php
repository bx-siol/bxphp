...
$_ENV['PAY_CONFIG']['qeapay'] = [
	'mch_id' => '400026789',
	'mch_key' => '7d888c4964b3433da0f78abb3ac20227',
	'pay_url' => 'https://payment.qeapay.com/pay/web',
	'query_url' => '',
	'notify_url' => 'http://'.PAY_BACKURL . '/api/Notify/qeapay/pay',
...
function payOrder($fin_paylog, $sub_type = '')
{
	...
	$logpathd = LOGS_PATH . "qeapay/pay/{$time}.txt";
	$pdata = [
		'version' => '1.0',
...
function payCurlPost($url, $data = [], $timeout = 30)
{
	...
	$time = date("Y-m-d", time());
	$logpath = LOGS_PATH . "qeapay/Post{$time}.txt";

# BxPlatform.AdminApi - 管理端 API 项目

## 项目概述

BxPlatform.AdminApi 是 BxPlatform 平台的管理端 API 项目，基于 .NET 8.0 开发，提供管理后台所需的所有接口功能。
...
### 2. Visual Studio 启动
打开解决方案，设置 BxPlatform.AdminApi 为启动项目，按 F5 运行。
...
```bash
cd publish
dotnet BxPlatform.AdminApi.dll
```

...
$_ENV['API_URL'] = 'http://223.223.217.120:8553/';

$_ENV['cnf_domain'] = '223.223.217.120:8553';
$_ENV['oauth_domain'] = '223.223.217.120:8553';
...
$_ENV['PAY_CONFIG']['nicepay'] = [
	...
	'returnUrl' => 'https://' . PAY_BACKURL_N . '/',
	'notifyUrl' => 'https://' . PAY_BACKURL_N . '/' . 'api/Notify/nicepay/cash',
	'dnotify_url' => 'https://' . PAY_BACKURL_N . '/' . 'api/Notify/nicepay/cash'
];
...
$_ENV['PAY_CONFIG']['bobopay'] = [
	...
	'returnUrl' => 'https://' . PAY_BACKURL_N . '/',
	'notify_url' => 'https://' . PAY_BACKURL_N . '/api/Notify/bobopay/pay',
	'dnotify_url' => 'https://' . PAY_BACKURL_N . '/' . 'api/Notify/bobopay/cash'
];
